/*Originally started using this method, but I really liked the method used on a walkthough and decided to implement it instead. 

This version has been changed back to original method for resubmission and provides the same results*/
